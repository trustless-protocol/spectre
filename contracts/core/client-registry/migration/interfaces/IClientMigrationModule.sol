...
/// @dev The `fast-ibc` preimages are compatibility identifiers. Renaming them changes the
///      resulting module IDs and makes deployed migration modules fail the router's identity check.
