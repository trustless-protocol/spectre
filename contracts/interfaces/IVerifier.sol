...
/// @notice Wrapper that decompresses Ed25519 points, packs canonical-vote
///         public inputs, and forwards to the underlying Groth16 verifier.
interface IVerifier {
    ...
    ///
    ///      The canonical-vote message is NOT passed here — the circuit reconstructs
    ///      it from `shared` + per-slot timestamp, so only ~22 Fr per slot flow into
    ///      the Groth16 public inputs.
