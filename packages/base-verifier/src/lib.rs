//! Base configuration and proof primitives for the ICS-08 Wasm client.
...
pub mod config;
/// Base update-header verification.
pub mod header;
#[cfg(test)]
mod profile_tests;

/// Thin Base adapter for the shared L2 contract entrypoints.
pub struct Adapter;
