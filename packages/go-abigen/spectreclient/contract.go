...
func (_Contract *ContractCaller) MISBEHAVIOURSUBMITTERROLE(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "MISBEHAVIOUR_SUBMITTER_ROLE")
...
//
// Solidity: function MISBEHAVIOUR_SUBMITTER_ROLE() view returns(bytes32)
func (_Contract *ContractSession) MISBEHAVIOURSUBMITTERROLE() ([32]byte, error) {
	return _Contract.Contract.MISBEHAVIOURSUBMITTERROLE(&_Contract.CallOpts)
}

// MISBEHAVIOURSUBMITTERROLE is a free data retrieval call binding the contract method 0xdb3e1fa4.
//
// Solidity: function MISBEHAVIOUR_SUBMITTER_ROLE() view returns(bytes32)
func (_Contract *ContractCallerSession) MISBEHAVIOURSUBMITTERROLE() ([32]byte, error) {
	return _Contract.Contract.MISBEHAVIOURSUBMITTERROLE(&_Contract.CallOpts)
}
...
func (_Contract *ContractCaller) GetPinnedValidatorSet(opts *bind.CallOpts) (struct {
	Indices      []uint32
	Pubkeys      [][32]byte
	VotingPowers []uint64
}, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "getPinnedValidatorSet")
...
//
// Solidity: function getPinnedValidatorSet() view returns(uint32[] indices, bytes32[] pubkeys, uint64[] votingPowers)
func (_Contract *ContractSession) GetPinnedValidatorSet() (struct {
	Indices      []uint32
	Pubkeys      [][32]byte
	VotingPowers []uint64
}, error) {
	return _Contract.Contract.GetPinnedValidatorSet(&_Contract.CallOpts)
}

// GetPinnedValidatorSet is a free data retrieval call binding the contract method 0x6edfe3af.
//
// Solidity: function getPinnedValidatorSet() view returns(uint32[] indices, bytes32[] pubkeys, uint64[] votingPowers)
func (_Contract *ContractCallerSession) GetPinnedValidatorSet() (struct {
	Indices      []uint32
	Pubkeys      [][32]byte
	VotingPowers []uint64
}, error) {
...
func (_Contract *ContractCaller) GetPinnedValidatorsHash(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Contract.contract.Call(opts, &out, "getPinnedValidatorsHash")
...
//
// Solidity: function getPinnedValidatorsHash() view returns(bytes32)
func (_Contract *ContractSession) GetPinnedValidatorsHash() ([32]byte, error) {
	return _Contract.Contract.GetPinnedValidatorsHash(&_Contract.CallOpts)
}

// GetPinnedValidatorsHash is a free data retrieval call binding the contract method 0x8c80fbda.
//
// Solidity: function getPinnedValidatorsHash() view returns(bytes32)
func (_Contract *ContractCallerSession) GetPinnedValidatorsHash() ([32]byte, error) {
	return _Contract.Contract.GetPinnedValidatorsHash(&_Contract.CallOpts)
}
...
func (_Contract *ContractTransactor) Unfreeze(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "unfreeze")
}

// Unfreeze is a paid mutator transaction binding the contract method 0x6a28f000.
//
// Solidity: function unfreeze() returns()
func (_Contract *ContractSession) Unfreeze() (*types.Transaction, error) {
	return _Contract.Contract.Unfreeze(&_Contract.TransactOpts)
}

// Unfreeze is a paid mutator transaction binding the contract method 0x6a28f000.
//
// Solidity: function unfreeze() returns()
func (_Contract *ContractTransactorSession) Unfreeze() (*types.Transaction, error) {
	return _Contract.Contract.Unfreeze(&_Contract.TransactOpts)
}
...
func (_Contract *ContractTransactor) UpdateApplicationState(opts *bind.TransactOpts, updateMsg []byte) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "updateApplicationState", updateMsg)
}

// UpdateApplicationState is a paid mutator transaction binding the contract method 0x4b1872be.
//
// Solidity: function updateApplicationState(bytes updateMsg) returns(uint8)
func (_Contract *ContractSession) UpdateApplicationState(updateMsg []byte) (*types.Transaction, error) {
	return _Contract.Contract.UpdateApplicationState(&_Contract.TransactOpts, updateMsg)
}

// UpdateApplicationState is a paid mutator transaction binding the contract method 0x4b1872be.
//
// Solidity: function updateApplicationState(bytes updateMsg) returns(uint8)
func (_Contract *ContractTransactorSession) UpdateApplicationState(updateMsg []byte) (*types.Transaction, error) {
	return _Contract.Contract.UpdateApplicationState(&_Contract.TransactOpts, updateMsg)
}
...
func (_Contract *ContractTransactor) UpdateConsensusState(opts *bind.TransactOpts, updateMsg []byte) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "updateConsensusState", updateMsg)
}

// UpdateConsensusState is a paid mutator transaction binding the contract method 0x92c19bdc.
//
// Solidity: function updateConsensusState(bytes updateMsg) returns(uint8)
func (_Contract *ContractSession) UpdateConsensusState(updateMsg []byte) (*types.Transaction, error) {
	return _Contract.Contract.UpdateConsensusState(&_Contract.TransactOpts, updateMsg)
}

// UpdateConsensusState is a paid mutator transaction binding the contract method 0x92c19bdc.
//
// Solidity: function updateConsensusState(bytes updateMsg) returns(uint8)
func (_Contract *ContractTransactorSession) UpdateConsensusState(updateMsg []byte) (*types.Transaction, error) {
	return _Contract.Contract.UpdateConsensusState(&_Contract.TransactOpts, updateMsg)
}
...
// ContractClientFrozenIterator is returned from FilterClientFrozen and is used to iterate over the raw logs and unpacked data for ClientFrozen events raised by the Contract contract.
type ContractClientFrozenIterator struct {
	Event *ContractClientFrozen // Event containing the contract specifics and raw log
...
func (it *ContractClientFrozenIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ContractClientFrozen)
...
func (it *ContractClientFrozenIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ContractClientFrozenIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ContractClientFrozen represents a ClientFrozen event raised by the Contract contract.
type ContractClientFrozen struct {
...
func (_Contract *ContractFilterer) FilterClientFrozen(opts *bind.FilterOpts) (*ContractClientFrozenIterator, error) {

	logs, sub, err := _Contract.contract.FilterLogs(opts, "ClientFrozen")
	if err != nil {
		return nil, err
	}
	return &ContractClientFrozenIterator{contract: _Contract.contract, event: "ClientFrozen", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ClientFrozen()
func (_Contract *ContractFilterer) WatchClientFrozen(opts *bind.WatchOpts, sink chan<- *ContractClientFrozen) (event.Subscription, error) {

	logs, sub, err := _Contract.contract.WatchLogs(opts, "ClientFrozen")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ContractClientFrozen)
				if err := _Contract.contract.UnpackLog(event, "ClientFrozen", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ClientFrozen()
func (_Contract *ContractFilterer) ParseClientFrozen(log types.Log) (*ContractClientFrozen, error) {
	event := new(ContractClientFrozen)
	if err := _Contract.contract.UnpackLog(event, "ClientFrozen", log); err != nil {
		return nil, err
	}
...
// ContractClientUnfrozenIterator is returned from FilterClientUnfrozen and is used to iterate over the raw logs and unpacked data for ClientUnfrozen events raised by the Contract contract.
type ContractClientUnfrozenIterator struct {
	Event *ContractClientUnfrozen // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ContractClientUnfrozenIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ContractClientUnfrozen)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ContractClientUnfrozenIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ContractClientUnfrozenIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ContractClientUnfrozen represents a ClientUnfrozen event raised by the Contract contract.
type ContractClientUnfrozen struct {
	Raw types.Log // Blockchain specific contextual infos
}
...
func (_Contract *ContractFilterer) FilterClientUnfrozen(opts *bind.FilterOpts) (*ContractClientUnfrozenIterator, error) {

	logs, sub, err := _Contract.contract.FilterLogs(opts, "ClientUnfrozen")
	if err != nil {
		return nil, err
	}
	return &ContractClientUnfrozenIterator{contract: _Contract.contract, event: "ClientUnfrozen", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ClientUnfrozen()
func (_Contract *ContractFilterer) WatchClientUnfrozen(opts *bind.WatchOpts, sink chan<- *ContractClientUnfrozen) (event.Subscription, error) {

	logs, sub, err := _Contract.contract.WatchLogs(opts, "ClientUnfrozen")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ContractClientUnfrozen)
				if err := _Contract.contract.UnpackLog(event, "ClientUnfrozen", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ClientUnfrozen()
func (_Contract *ContractFilterer) ParseClientUnfrozen(log types.Log) (*ContractClientUnfrozen, error) {
	event := new(ContractClientUnfrozen)
	if err := _Contract.contract.UnpackLog(event, "ClientUnfrozen", log); err != nil {
		return nil, err
	}
...
// ContractClientUpdatedIterator is returned from FilterClientUpdated and is used to iterate over the raw logs and unpacked data for ClientUpdated events raised by the Contract contract.
type ContractClientUpdatedIterator struct {
	Event *ContractClientUpdated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ContractClientUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ContractClientUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ContractClientUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ContractClientUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ContractClientUpdated represents a ClientUpdated event raised by the Contract contract.
type ContractClientUpdated struct {
	Height uint64
	Raw    types.Log // Blockchain specific contextual infos
}
...
func (_Contract *ContractFilterer) FilterClientUpdated(opts *bind.FilterOpts) (*ContractClientUpdatedIterator, error) {

	logs, sub, err := _Contract.contract.FilterLogs(opts, "ClientUpdated")
	if err != nil {
		return nil, err
	}
	return &ContractClientUpdatedIterator{contract: _Contract.contract, event: "ClientUpdated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ClientUpdated(uint64 height)
func (_Contract *ContractFilterer) WatchClientUpdated(opts *bind.WatchOpts, sink chan<- *ContractClientUpdated) (event.Subscription, error) {

	logs, sub, err := _Contract.contract.WatchLogs(opts, "ClientUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ContractClientUpdated)
				if err := _Contract.contract.UnpackLog(event, "ClientUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ClientUpdated(uint64 height)
func (_Contract *ContractFilterer) ParseClientUpdated(log types.Log) (*ContractClientUpdated, error) {
	event := new(ContractClientUpdated)
	if err := _Contract.contract.UnpackLog(event, "ClientUpdated", log); err != nil {
		return nil, err
	}
...
// ContractConsensusStateUpdatedIterator is returned from FilterConsensusStateUpdated and is used to iterate over the raw logs and unpacked data for ConsensusStateUpdated events raised by the Contract contract.
type ContractConsensusStateUpdatedIterator struct {
	Event *ContractConsensusStateUpdated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ContractConsensusStateUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ContractConsensusStateUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ContractConsensusStateUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ContractConsensusStateUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ContractConsensusStateUpdated represents a ConsensusStateUpdated event raised by the Contract contract.
type ContractConsensusStateUpdated struct {
	Height         uint64
...
func (_Contract *ContractFilterer) FilterConsensusStateUpdated(opts *bind.FilterOpts) (*ContractConsensusStateUpdatedIterator, error) {

	logs, sub, err := _Contract.contract.FilterLogs(opts, "ConsensusStateUpdated")
	if err != nil {
		return nil, err
	}
	return &ContractConsensusStateUpdatedIterator{contract: _Contract.contract, event: "ConsensusStateUpdated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ConsensusStateUpdated(uint64 height, bytes32 validatorsHash)
func (_Contract *ContractFilterer) WatchConsensusStateUpdated(opts *bind.WatchOpts, sink chan<- *ContractConsensusStateUpdated) (event.Subscription, error) {

	logs, sub, err := _Contract.contract.WatchLogs(opts, "ConsensusStateUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ContractConsensusStateUpdated)
				if err := _Contract.contract.UnpackLog(event, "ConsensusStateUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ConsensusStateUpdated(uint64 height, bytes32 validatorsHash)
func (_Contract *ContractFilterer) ParseConsensusStateUpdated(log types.Log) (*ContractConsensusStateUpdated, error) {
	event := new(ContractConsensusStateUpdated)
	if err := _Contract.contract.UnpackLog(event, "ConsensusStateUpdated", log); err != nil {
		return nil, err
	}
