...
// attestedExampleJSON locks the branch-local legacy Go wire shape. The shared
// fixture intentionally remains unsigned so Rust can reject it as a signed header;
// PR #475 adds the indexed-signature producer and the valid signed vector.
