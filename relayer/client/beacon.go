// The beacon API and the SSZ helpers it needs. Split out of ethereum.go because
// the beacon chain is a different counterparty from an EVM JSON-RPC endpoint,
// which is the axis this package names its files on.
package client
