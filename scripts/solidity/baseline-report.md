...
- Prover repair: N4 R1CS, PK, VK, and Solidity verifier are generated and smoke-tested as one randomized pair. Runtime provenance is written under ignored `.artifacts/solidity/prover/`.
