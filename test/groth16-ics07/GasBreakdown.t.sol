...
contract MockUpdateClientPassThrough is IUpdateClient {
    ...
    function _passThrough(IUpdateClientMsgs.MsgUpdateClient calldata msg_)
        private
        pure
        returns (IUpdateClientMsgs.UpdateClientOutput memory output)
    {
...
contract GasBreakdownTest is Test, IICS07TendermintMsgs {
    ...
    function setUp() public {
        ...
        uint32[] memory trustedOverlapIndices = new uint32[](4);
        trustedOverlapIndices[0] = 0;
        trustedOverlapIndices[1] = 1;
        trustedOverlapIndices[2] = 2;
        trustedOverlapIndices[3] = type(uint32).max;
        ...
        updateMsg.trustedOverlapIndices = trustedOverlapIndices;
    ...
    function _initRealProofFixture() internal {
        ...
        realUpdateMsg_.trustedOverlapIndices = _uint32Array4(0, 1, 2, 3);
