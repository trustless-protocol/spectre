...
abstract contract MembershipTest is Groth16ICS07TendermintTest {
    ...
    struct Groth16ICS07MembershipFixtureJson {
        Height proofHeight;
    ...
    Groth16ICS07MembershipFixtureJson public fixture;
    ...
    function loadFixture(string memory fileName) public view returns (Groth16ICS07MembershipFixtureJson memory) {
        ...
        Groth16ICS07MembershipFixtureJson memory fix = Groth16ICS07MembershipFixtureJson({
